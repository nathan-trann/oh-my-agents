# GEMINI.md Output Template

This template defines the structure for generated GEMINI.md files. Follows the same WHAT/WHY/HOW pattern as CLAUDE.md but adapted for Gemini CLI conventions. Uses generic framing for overrides (no Claude-specific thresholds).

---

## Root GEMINI.md Structure
...
## Nested GEMINI.md Structure

Identical structure to nested CLAUDE.md — chunk-specific info only:
...
Same as CLAUDE.md template — see `templates/output/claude-md.md` for the full variable reference.
